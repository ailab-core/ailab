...
const navigationMenuTriggerStyle = cva(
  "bg-background focus-visible:ring-ring/50 data-popup-open:text-sky-300 data-popup-open:hover:text-sky-300 rounded-lg px-2.5 py-1.5 text-sm font-medium transition-all focus-visible:ring-3 focus-visible:outline-1 disabled:opacity-50 group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center disabled:pointer-events-none outline-none cursor-pointer"
)
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn("data-active:focus:text-sky-300 data-active:hover:text-sky-300 data-active:text-sky-300 focus-visible:ring-ring/50 focus:text-sky-300 hover:text-sky-300 focus:bg-muted flex items-center gap-2 rounded-lg p-2 text-sm transition-all outline-none focus-visible:ring-3 focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4 cursor-pointer", className)}
      {...props}
    />
  )
}
